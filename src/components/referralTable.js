...
export default function ReferralTable({truncateText, refObject}) {
    const refObj2=
    {
  ...
  return (
    <>
        <li className="refprof">
            <img src={refObject.img} alt="b"/>
            <div className="refasset">
                <h5>{refObject.asset}</h5>
                <div className='refpers'>
                    <p>{refObject.type}</p>
                    <button>
                        <img src={refObject.chain.img} alt="avatar" />
                        <small>{refObject.chain.name}</small>
                    </button>
                </div>
            </div>
            
        </li>
        <li className='refstatus'>
